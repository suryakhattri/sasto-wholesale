...
//
//     final topProductAllItemModel = topProductAllItemModelFromJson(jsonString);

import 'package:meta/meta.dart';
import 'dart:convert';

TopProductAllItemModel topProductAllItemModelFromJson(String str) => TopProductAllItemModel.fromJson(json.decode(str));

String topProductAllItemModelToJson(TopProductAllItemModel data) => json.encode(data.toJson());

class TopProductAllItemModel {
  TopProductAllItemModel({
    required this.data,
    required this.links,
    required this.meta,
  });
  ...
  factory TopProductAllItemModel.fromJson(Map<String, dynamic> json) => TopProductAllItemModel(
    data: List<TopProductData>.from(json["data"].map((x) => TopProductData.fromJson(x))),
