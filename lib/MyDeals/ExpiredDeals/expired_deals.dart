...
class _ExpiredDealsState extends State<ExpiredDeals> {
  late Future<AllDealModel> _expiredDealData;

  @override
  void initState() {
    super.initState();
    _expiredDealData = fetchExpiredDealData();
  }

  @override
  Widget build(BuildContext context) {
    return FutureBuilder<AllDealModel>(
      future: _expiredDealData,
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: ListView.builder(
                                        itemCount: model
                                            .data[index].dealProducts.length,
                                        shrinkWrap: true,
                                        physics: NeverScrollableScrollPhysics(),
                                        itemBuilder: (context, index) {
                                          return Padding(
...
Future<AllDealModel> fetchExpiredDealData() async {
  ...
  var url = 'https://seller.sastowholesale.com/api/deals?status=expired&page=1';
