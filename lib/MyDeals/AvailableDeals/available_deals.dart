...
class _AvailableDealsState extends State<AvailableDeals> {
  ...
  late Future<AllDealModel> _allAvailableData;

  @override
  void initState() {
    super.initState();
    _allAvailableData = fetchAvailableDealData();
  }
...
Future<AllDealModel> fetchAvailableDealData() async {
