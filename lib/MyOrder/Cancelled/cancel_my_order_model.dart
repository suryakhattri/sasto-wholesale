...
//
//     final cancelMyOrderModel = cancelMyOrderModelFromJson(jsonString);

import 'package:meta/meta.dart';
import 'dart:convert';

CancelMyOrderModel cancelMyOrderModelFromJson(String str) => CancelMyOrderModel.fromJson(json.decode(str));

String cancelMyOrderModelToJson(CancelMyOrderModel data) => json.encode(data.toJson());

class CancelMyOrderModel {
  CancelMyOrderModel({
  ...
  factory CancelMyOrderModel.fromJson(Map<String, dynamic> json) => CancelMyOrderModel(
