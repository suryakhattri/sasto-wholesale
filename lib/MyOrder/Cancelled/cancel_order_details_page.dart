...
class CandelOrderDetailsPage extends StatefulWidget {
  const CandelOrderDetailsPage({Key? key, required this.orderId}) : super(key: key);

  final int orderId;

  @override
  _CandelOrderDetailsPageState createState() => _CandelOrderDetailsPageState();
}

class _CandelOrderDetailsPageState extends State<CandelOrderDetailsPage> {
...
Future<ManageOrderModel> fetchManageOrder(var orderId) async {
  ...
  final response = await http.get(
      Uri.parse('https://seller.sastowholesale.com/api/customer/orders/' + orderId.toString() + 'status=cancelled'),
      headers: header);
