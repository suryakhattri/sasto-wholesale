...
import 'package:sasto_wholesale/MyOrder/Unpaid/unpaid_details_page.dart';
...
class _UnpaidOrderState extends State<UnpaidOrder> {
  ...
  late Future<AllOrderModel> _unPaidOrderModel;

  @override
  void initState() {
    super.initState();
    _unPaidOrderModel = fetchUnpaidMyOrder();
  }
...
Future<AllOrderModel> fetchUnpaidMyOrder() async {
  ...
  final response = await http.get(
      Uri.parse('https://seller.sastowholesale.com/api/customer/orders?status=unpaid'),
      headers: header);
