...
class UnpaidOrderDetailsPage extends StatefulWidget {
  const UnpaidOrderDetailsPage({Key? key, required this.orderId}) : super(key: key);

  final int orderId;

  @override
  _UnpaidOrderDetailsPageState createState() => _UnpaidOrderDetailsPageState();
}

class _UnpaidOrderDetailsPageState extends State<UnpaidOrderDetailsPage> {
...
Future<ManageOrderModel> fetchManageOrder(var orderId) async {
  ...
  final response = await http.get(
      Uri.parse('https://seller.sastowholesale.com/api/customer/orders/' + orderId.toString() + 'status=unpaid'),
      headers: header);
