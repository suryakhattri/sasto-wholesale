...
class ManageOrder extends StatefulWidget {
  const ManageOrder({Key? key, required this.orderId}) : super(key: key);
                                    ...
                                    return Column(
                                      children: [
                                        ListTile(
                                          ...
                                          trailing: Text(
                                            "Rs: ${snapshot.data!.orderLists[index].subtotalPrice.toString()} * ${snapshot.data!.orderLists[index].quantity.toString()}",
                                            style: TextStyle(
                                                fontSize: 16,
                                                fontWeight: FontWeight.bold),
                                          ),
...
Future<ManageOrderModel> fetchManageOrder(var orderId) async {
  ...
  final response = await http.get(
      Uri.parse('https://seller.sastowholesale.com/api/customer/orders/' + orderId.toString()),
      headers: header);
