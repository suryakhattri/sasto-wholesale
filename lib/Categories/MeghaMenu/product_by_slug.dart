...
class ProductBySlug extends StatefulWidget {
  const ProductBySlug({Key? key, required this.slug}) : super(key: key);
  final String slug;

  @override
  _ProductBySlugState createState() => _ProductBySlugState();
}

class _ProductBySlugState extends State<ProductBySlug> {
  ...
  void initState() {
    super.initState();
    _productListData = fetchProductListBySlug(widget.slug);
  }
...
Future<List<TopProductData>> fetchProductListBySlug(String slug) async {
  final response = await http
      .get(Uri.parse('https://seller.sastowholesale.com/api/products?prod_cat=${slug}'));
