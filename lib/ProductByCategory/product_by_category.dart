...
class ProductByCategory extends StatefulWidget {
  const ProductByCategory({Key? key, required this.slug, required this.title}) : super(key: key);
  final String slug;
  final String title;
...
class _ProductByCategoryState extends State<ProductByCategory> {
  ...
  late Future<List<TopProductData>> _productHotCatListData;

  @override
  void initState() {
    super.initState();
    _productHotCatListData = fetchHotCatList(widget.slug);
  }
...
Future<List<TopProductData>> fetchHotCatList(String slug) async {
  final response = await http
      .get(Uri.parse('https://seller.sastowholesale.com/api/products?subcat=${slug}'));
