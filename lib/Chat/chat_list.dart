...
import 'package:sasto_wholesale/Chat/pusher_demo.dart';
                            ...
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) => new ChatDetails(
                                           userId: snapshot.data!.data[index].customerUserId,
                                      vendorId: snapshot.data!.data[index].vendorUserId, id: snapshot.data!.data[index].id,
