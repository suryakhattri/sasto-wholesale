...
//     prefs.setString("apiKey", "def24be273f469943a0f");
//     prefs.setString("cluster", "ap2");
//     prefs.setString("channelName", "b2b");
//
//     try {
//       await pusher.init(
//         apiKey: _apiKey.text,
...
//       );
//       var subscribe = await pusher.subscribe(channelName: _channelName.text,onEvent: onEvent,onSubscriptionSucceeded: onSubscriptionSucceeded);
...
//         channelName: "${_channelName.text.toString()}",
//         eventName: _eventName.text.toString(),
//         data: _data.text.toString(),userId: "test"));
//   }
//
...
//     // SharedPreferences prefs = await SharedPreferences.getInstance();
//     setState(() {
//       _apiKey.text = "def24be273f469943a0f";
//       _cluster.text = "ap2";
//       _channelName.text = "b2b";
//       _eventName.text = "test";
//       _data.text = "test";
//     });
//   }
//
